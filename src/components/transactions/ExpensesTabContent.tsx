...
interface ExpensesTabContentProps {
  ...
  chartData: Array<{ month: string; expenses: number }>
        ...
        <CardHeader className="pb-3 sm:pb-4">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 sm:gap-4">
            <CardTitle className="text-sm sm:text-base">
              All Expenses ({filteredAndSortedTransactions.length})
            </CardTitle>
            <div className="flex gap-2">
              <Select
                    ...
                    {transactions.map((transaction) => (
                      ...
                      >
                        ...
                        <td className="py-3 px-3 lg:px-4 text-right">
                          <span className="font-semibold text-xs sm:text-sm text-red-600 dark:text-rose-400">
                  ...
                  >
                    <div className="flex justify-between items-start mb-2 sm:mb-3">
                      ...
                      <div className="text-right flex-shrink-0 ml-2">
                        <p className="font-bold text-base sm:text-lg text-red-600 dark:text-rose-400">
                          -{formatCurrency(transaction.amount)}
                        </p>
                      </div>
                    </div>
              ...
              {totalPages > 1 && (
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mt-4 sm:mt-6">
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400 text-center sm:text-left">
                    Showing {startIndex + 1} to {Math.min(endIndex, filteredAndSortedTransactions.length)} of {filteredAndSortedTransactions.length} expenses
                  </p>
